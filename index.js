...
console.log("Welcome " + userName + " to - DO YOU KNOW SUMEDH?");
...
function play(question, answer) {
  ...
  if (userAnswer.toUpperCase() === answer.toUpperCase()) {
    console.log("Right! Seems like you really know Sumedh.");
    score = score + 1;
  } else {
...
var questions = [
  ...
  {
    question: "Here's the last question - Who is my favorite cricket player? ",
    answer: "Rohit Sharma",
  }
]
